...
TernaryPlot(alab = expression(paste("Percentage of  ", italic(A.~arabiensis))),
            blab = expression(paste("Percentage of  ", italic(A.~coluzzii))),
            clab = expression(paste("Percentage of  ", italic(A.~gambiae), "  s.s.")))
